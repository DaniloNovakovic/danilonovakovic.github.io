export const miniGameMessages = {
  ...
  coding: {
    ...
    helpResponse:
      "Available commands: whoami, skills, enter <scene-name>, clear\nTry 'enter -h' to list scenes.",
    ...
    enterUnknownScene: (sceneName: string) => `Unknown scene: ${sceneName}`,
    enteringScene: (sceneName: string) => `Entering ${sceneName}...`,
