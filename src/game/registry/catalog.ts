import { BASEMENT_FEATURE_CATALOG_ENTRIES } from '@game/scenes/basement/catalog';
import type { FeatureCatalogEntry } from './catalogTypes';
import { HOBBIES_FEATURE_CATALOG_ENTRIES } from '@game/scenes/hobbies/catalog';
import { PORTFOLIO_FEATURE_CATALOG_ENTRIES } from '@game/portfolio/catalog';
import { POTASSIUM_SLIP_FEATURE_CATALOG_ENTRIES } from '@game/scenes/potassiumSlip/catalog';
