...
export const TEST_ROUTE_DIALOGUE_CATALOG: RidgeRouteDialogueCatalog = {
  ...
  dance: {
    ...
    lines: {
      ...
      'dance.traveler.relay_wayfinding.03': 'Ask at the shuttle and operations table.',
      ...
      'dance.operations_helper.handoff_check.01': 'If the lantern line fails, I fail.',
      'dance.operations_helper.handoff_check.02': 'Check the details with me once.',
      'dance.operations_helper.handoff_check.03': 'Help with the operations handoff',
      'dance.operations_helper.handoff_check.done.01': 'The teacher can keep watch.',
      'dance.operations_helper.handoff_check.done.02': 'She almost believes the plaza can breathe.',
      'dance.locals.triangulated_read.01': 'Road opens after setup check.',
      'dance.locals.triangulated_read.02': 'She waits on one perfect lantern. He waits on anything except asking.',
      'dance.locals.triangulated_read.03': 'They practice the art of being unavailable.',
      ...
      'dance.driver.folded_song_request.01': 'Help me fold a tiny song request.',
