...
const OVERWORLD_BUILDING_ART: Record<string, (g: Graphics) => void> = {
...
const PIXEL_BUILDING_PALETTES: Record<string, { base: number; accent: number }> = {
 ...
 */
export function drawOverworldBuildingArt(bg: Graphics, id: string): void {
 ...
 */
export function drawPixelOverworldBuildingArt(bg: Graphics, id: string): void {
