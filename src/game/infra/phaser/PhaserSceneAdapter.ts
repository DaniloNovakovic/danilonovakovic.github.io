...
/**
 * Adapter from the engine-agnostic scene kernel to Phaser's concrete scene API.
 *
 ...
 * kernel requests into Phaser calls, while also translating repo-level scene
...
export class PhaserSceneAdapter implements SceneRuntimeAdapter {
  ...
  /**
   * Starts a Phaser scene with kernel-composed start data.
   */
   ...
   *
   * The kernel asks for pause propagation once; this adapter decides which
