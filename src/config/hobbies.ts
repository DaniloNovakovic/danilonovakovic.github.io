...
export const MINI_GAMES: MiniGamePlugin[] = [
  {
    id: 'drawing',
    name: 'Drawing',
    x: 400,
...
// Keep HOBBIES for backward compatibility during transition if needed, 
// but we should update imports.
export const HOBBIES = MINI_GAMES;
