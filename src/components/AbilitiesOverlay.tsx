    ...
    <div className="text-[#1a1a1a]">
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg border-4 border-[#1a1a1a] shadow-[8px_8px_0px_0px_rgba(26,26,26,1)]">
          <h3 className="text-xl font-bold mb-4 border-b-2 border-gray-100 pb-2">Skills</h3>
        ...
        {/* Tools */}
        <div className="bg-white p-6 rounded-lg border-4 border-[#1a1a1a] shadow-[8px_8px_0px_0px_rgba(26,26,26,1)]">
          <h3 className="text-xl font-bold mb-4 border-b-2 border-gray-100 pb-2">Tools</h3>
          <div className="flex flex-wrap gap-2">
        ...
        {/* Languages */}
        <div className="bg-white p-6 rounded-lg border-4 border-[#1a1a1a] shadow-[8px_8px_0px_0px_rgba(26,26,26,1)]">
          <h3 className="text-xl font-bold mb-4 border-b-2 border-gray-100 pb-2">Languages</h3>
