...
- [`index.html`](./index.html) - static comparison lab with Stable Hybrid and
  Notebook Hybrid toggles plus desktop, phone portrait, phone landscape, tablet,
  and tablet landscape previews.
- [`tournament.html`](./tournament.html) - scene-template tournament with
  Current Overworld, Ridge, Potassium, Stampede, Telegraph, and Domino previews
  across practical, expressive, and mobile-first variants.
- [`notebook-shell-moodboard.png`](./notebook-shell-moodboard.png) - generated
  mood frame that acts as the visual north star for Notebook Hybrid.
- [`notebook-template-tournament-moodboard.png`](./notebook-template-tournament-moodboard.png) -
  generated four-panel mood frame for spread, Potassium board, Stampede arena,
  and Ridge/Overworld template directions.
